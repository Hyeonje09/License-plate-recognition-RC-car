...
def car(num) : 
    ...
    svm = cv2.ml.SVM_load("/home/right/opencvTest/SVMtrain.xml")                  # 학습된 데이터 적재
    ...
    K1, K2 = 10, 10
    nknn = kNN_train("/home/right/opencvTest/chap12/images/train_numbers.png", K1, 10, 20) # 숫자 학습
    tknn = kNN_train("/home/right/opencvTest/chap12/images/train_texts.png", K2, 40, 20)   # 문자 학습
...
def tracking() :
    ...
    while 1 :
        ...
        if ret :
            ...
            if key == 27:
                cv2.imwrite('/home/right/Downloads/images/test_car/' + str(count) + ".jpg", frame)
                car(count)
                count += 1
